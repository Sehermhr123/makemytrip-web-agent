...
import makemytripLogo from "../logo/makemytrip-seeklogo.png";
        ...
        <div className="w-full max-w-[420px] rounded-2xl border border-border bg-card p-9 shadow-md">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-5">
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-md border border-input bg-background px-3.5 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-mmt-blueLight"
                autoFocus
              />
            </div>
            ...
            <Button
              ...
              className="h-11 w-full bg-mmt-blue text-white shadow-sm hover:bg-mmt-blueLight"
            >
          ...
          <div className="mt-5 border-t border-border pt-4">
            <button
              ...
              className="text-xs font-medium text-mmt-red transition-colors hover:underline"
            >
                ...
                <div className="flex flex-wrap gap-2">
                  {DEMO_ACCOUNTS.map((acc) => (
                    <button
                      ...
                      className="rounded-full border border-border bg-background px-3 py-1.5 text-xs text-muted-foreground transition-colors hover:border-mmt-blueLight hover:text-mmt-blueLight"
                    >
                      {acc.role}
                    </button>
                  ))}
